					...
					Si (ronda==1) Entonces //ronda de entrada para ubicar barcos
						...
						Para i<-0 hasta 2 hacer //ubica 3 barcos dobles
							...
							Segun (elecPosCOM)
								Caso 1: //CASO BARCO DOBLE HORIZONTAL
									...
									Mientras que ((tableroCOM[jugadaFCOM, jugadaCCOM]=="2") o (tableroCOM[jugadaFCOM, jugadaCCOM+1]=="2")) //verifica que no pise otro barco doble
								Caso 2: //CASO BARCO DOBLE VERTICAL
									Hacer
										jugadaFCOM=Aleatorio(0,3)
										jugadaCCOM=Aleatorio(0,4)
									Mientras que ((tableroCOM[jugadaFCOM, jugadaCCOM]=="2") o (tableroCOM[jugadaFCOM+1, jugadaCCOM]=="2")) //verifica que no pise otro barco doble
							FinSegun
						...
						Para i<-0 hasta 3 hacer //ubica 4 barcos simples
							Hacer
								jugadaFCOM=Aleatorio(0,4)
								jugadaCCOM=Aleatorio(0,4)
							Mientras que ((tableroCOM[jugadaFCOM, jugadaCCOM]=="1") o (tableroCOM[jugadaFCOM, jugadaCCOM]=="2")) //verifica que no pise otro barco simple o doble
