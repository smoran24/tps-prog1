Algoritmo Generador_Contraseña
	...
	tamanioArray=8
	Dimension arrayPassword[tamanioArray]
	Definir digito Como Entero
	Definir contraseña como cadena
	Escribir "[Generador de Contraseñas Numéricas]"
	Escribir "Creando contraseña de 8 dígitos..."
	Para i<-0 Hasta tamanioArray-1 Con Paso 1 Hacer //bucle que guarda cada numero entero generado aleatoriamente en el arreglo que contendrá la contraseña
		digito=Aleatorio(0,9)
		arrayPassword[i]=digito
	Fin Para
	Para i<-0 Hasta tamanioArray-1 Con Paso 1 Hacer //bucle que recorre el array y construye la contraseña (cadena), donde cada digito numérico es convertido a texto para poder concatenarlos en tal cadena
