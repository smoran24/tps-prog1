Algoritmo Numeros_Primos
	...
	tamanioArray=25
	Dimension arrayNumerosPrimos[tamanioArray] //los numeros primos del 1 al 100 son 25 en total
	...
	Para num=1 hasta 100 con paso 1 hacer //bucle que recorre números del 1 al 100
		...
		Si (divisiones==2) Entonces //las unicas dos veces que es divisible un número primo son consigo mismo y con 1
			arrayNumerosPrimos[cuentaPrimos]=num //almacena el número primo encontrado en el arreglo
			cuentaPrimos=cuentaPrimos+1 //suma 1 al contador de primos (que además sirve de indice para el arreglo)
		Finsi
	FinPara
	
	Para i<-0 Hasta tamanioArray-1 Con Paso 1 Hacer //bucle que muestra en pantalla el contenido del arreglo de números primos
		Escribir "El número primo ", arrayNumerosPrimos[i], " se encuentra en la pos. ", i
	Fin Para
